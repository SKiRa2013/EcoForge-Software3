...
public class SistemaCombate : MonoBehaviour
{
    ...
    void VerificarReferencias()
    {
        ...
        if (botones.Length != 6)
        {
            Debug.LogWarning("Se esperaban 6 botones pero se encontraron " + botones.Length + ". Algunas acciones pueden no estar disponibles.");
        }
    }
    ...
    void AsignarListenersBotones()
    {
        for (int i = 0; i < botones.Length; i++)
        {
            ...
            {
                Debug.LogWarning("El botón en el índice " + i + " no está asignado");
            }
        }
    }
    ...
    void AtaqueDebil()
    {
        ...
        Debug.Log("Ataque Débil: " + dañoBase + " base -> " + dañoFinal.ToString("F1") + " daño final");
    }
    ...
    void AtaqueFuerte()
    {
        ...
        Debug.Log("Ataque Fuerte: " + dañoBase + " base -> " + dañoFinal.ToString("F1") + " daño final");
    }
    ...
    IEnumerator TurnoEnemigo()
    {
        ...
        Debug.Log("Ataque enemigo: " + dañoEnemigo + " base -> " + dañoFinal.ToString("F1") + " daño a la bruja");
    ...
    void ActualizarVidaJugador()
    {
        ...
        {
            healthBarText.text = "VIDA: " + brujaVida.ToString("F0") + "/1000";
        }
    }
    ...
    void ActualizarMana()
    {
        if (manaBarText != null)
        {
            manaBarText.text = "MANA: " + brujaMana.ToString("F0") + "/1000";
        }
    }
    ...
    void ActualizarBarraEnemigo()
    {
        ...
        {
            healthBarEnemyText.text = "VIDA ENEMIGO: " + caballeroVida.ToString("F0") + "/1000";
        }
    }

    void ActualizarStatsJugador()
    {
        Debug.Log("Stats Bruja - Vida: " + brujaVida.ToString("F0") + ", Mana: " + brujaMana.ToString("F0") + ", Fuerza: " + brujaFuerza.ToString("F1") + ", Defensa: " + brujaDefensa.ToString("F1"));
    }

    void ActualizarStatsEnemigo()
    {
        Debug.Log("Stats Caballero - Vida: " + caballeroVida.ToString("F0") + ", Fuerza: " + caballeroFuerza.ToString("F1") + ", Defensa: " + caballeroDefensa.ToString("F1"));
    }
}